# -*- encoding: utf-8 -*-
# stub: win32console 1.3.2 ruby lib
# stub: ext/Console_ext/extconf.rb
...
Gem::Specification.new do |s|
  ...
  s.extensions = ["ext/Console_ext/extconf.rb".freeze]
  ...
  s.files = ["History.txt".freeze, "Manifest.txt".freeze, "README.txt".freeze, "ext/Console_ext/extconf.rb".freeze, "extra/Console.rdoc".freeze, "extra/Console_ANSI.rdoc".freeze]
